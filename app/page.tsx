        ...
        <main className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/healthy"
                className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-lg text-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Report
              </Link>
              <Link
                href="/dashboard"
                className="border-2 border-white text-white hover:bg-white hover:text-green-600 px-8 py-3 rounded-lg text-lg font-medium transition-all duration-300"
              >
                Dashboard
              </Link>
            </div>
